...
LDLIBS = -larith40 -lnetpbm -lcii40 -lm -lrt -lpnm
...
40image-6: 40image.o a2plain.o a2blocked.o uarray2b.o uarray2.o RGBtoFloats.o \
	changeNums.o RGBFloatsToCompVid.o DiscreteCosTrans.o ScaleABCD.o bitpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
